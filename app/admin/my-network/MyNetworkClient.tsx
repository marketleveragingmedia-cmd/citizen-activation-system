  ...
  return (
    <div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
        ...
        <div className={dashboardStyles.card.stat}>
          <div className={dashboardStyles.statCard.label}>Average per Partner</div>
          <div className={dashboardStyles.statCard.value}>
            {network.totalPartners > 0 
              ? (network.totalActivations / network.totalPartners).toFixed(1)
              : '0'}
          </div>
        </div>
      </div>
      ...
      <div className={dashboardStyles.card.base + ' p-6'}>
        <h3 className="text-lg font-bold text-gray-900 mb-4">Your Strategic Partners</h3>
