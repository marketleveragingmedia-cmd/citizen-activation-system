...
export default function OrgAdminCheckout() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const response = await fetch('/api/checkout/org-admin', {
        method: 'POST',
      ...
      <div className="max-w-md mx-auto bg-white rounded-lg shadow-md p-8">
        <div className="text-center mb-8">
          ...
          <div className="bg-green-50 border-2 border-green-500 rounded-lg p-4 mb-4">
            <div className="text-2xl font-bold text-green-700">$997</div>
            <div className="text-sm text-green-600">Year 1, then $497/year</div>
          </div>
        </div>
        ...
        <div className="mb-6 space-y-3 text-sm text-gray-700">
          ...
          <ul className="space-y-2">
            <li className="flex items-start">
              ...
              <span>Organization branding & customization</span>
            </li>
            <li className="flex items-start">
              <span className="text-green-500 mr-2">✓</span>
              <span>See only YOUR network/members</span>
            </li>
            <li className="flex items-start">
              <span className="text-green-500 mr-2">✓</span>
              <span>Bulk onboarding tools for large groups</span>
            </li>
            <li className="flex items-start">
              <span className="text-green-500 mr-2">✓</span>
              <span>Add Team Admins (earn commission)</span>
            </li>
            <li className="flex items-start">
              <span className="text-green-500 mr-2">✓</span>
              <span>Perfect for communities with existing member base</span>
            </li>
          </ul>
        </div>
