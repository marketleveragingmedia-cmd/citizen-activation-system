...
interface TeamAdminNetworkViewerProps {
  partners: any[]
}

export default function TeamAdminNetworkViewer({ partners }: TeamAdminNetworkViewerProps) {
  ...
  if (partners.length === 0) {
    return (
      <div className="text-center py-12 text-gray-500">
        ...
        <p className="text-sm mt-2">This Team Admin hasn't added any Strategic Partners</p>
      </div>
    )
  }
  ...
  return (
    <div>
      <h3 className="text-lg font-bold text-gray-900 mb-4">
        Strategic Partners ({partners.length})
      </h3>
